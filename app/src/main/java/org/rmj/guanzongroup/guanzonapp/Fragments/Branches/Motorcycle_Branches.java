...
public class Motorcycle_Branches extends Fragment {
    ...
    private void setupWidgets(){
        RecyclerView recyclerView = view.findViewById(R.id.recycler_view_fragment_branch_motorcycle);
    ...
    private Adapter_Branch getBranchAdapter(){
        ...
        ArrayList<ArrayList<String>> arr_Branches = new LocalDataBranches(getActivity()).getMotorBranches();

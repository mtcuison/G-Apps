...
package org.rmj.g3appdriver.Http;
...
import org.rmj.g3appdriver.Database.Repositories.RRawData;
...
public class HttpHeaders {
    ...
    private final RRawData poToken;
    ...
    private HttpHeaders(Application application){
        ...
        this.poToken = new RRawData(application);
        this.appData = new AppData(application.getApplicationContext());
    }

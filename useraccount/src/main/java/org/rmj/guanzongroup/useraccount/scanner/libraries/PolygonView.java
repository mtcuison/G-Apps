...
package org.rmj.guanzongroup.useraccount.scanner.libraries;
...
public class PolygonView extends FrameLayout {
    ...
    private void initPaint() {
        paint = new Paint();
        paint.setColor(getResources().getColor(R.color.guanzon_digital_grey));
            ...
            switch (eid) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (isValidShape(getPoints())) {
                        color = getResources().getColor(R.color.guanzon_digital_grey);
                    } else {
                        color = getResources().getColor(R.color.guanzon_digital_orange);
                    }
                    paint.setColor(color);
                    dismissMag();
                    break;

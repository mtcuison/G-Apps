...
//    public static String URL_IMPORT_TRANSACTIONS_OFFLINE = main_url + "gcard/ms/import_trans_offline.php";
//    public static String URL_IMPORT_TRANSACTIONS_ONLINE = main_url + "gcard/ms/import_trans_online.php";
//    public static String URL_IMPORT_TRANSACTIONS_PREORDER = main_url +  "gcard/ms/import_trans_preorder.php";
//    public static String URL_IMPORT_TRANSACTIONS_REDEMPTION = main_url + "gcard/ms/import_trans_redemption.php";
...
//    public static String URL_CHANGE_PASSWORD = main_url + "security/acctupdate.php";
//    public static String URL_REQUEST_DEVICES = main_url + "security/acctdevice.php";
//    public static String URL_IMPORT_EVENTS = main_url + "gcard/mx/import_events.php";
//    public static String URL_CLIENT_LOGIN = main_url + "security/signin.php";
//
//    public static String SEND_RESPONSE = main_url + "notification/send_response.php";

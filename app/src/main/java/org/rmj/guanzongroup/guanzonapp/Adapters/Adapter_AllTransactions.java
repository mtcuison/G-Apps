...
public class Adapter_AllTransactions extends RecyclerView.Adapter<Adapter_AllTransactions.TransactionsViewHolder> {
    ...
    private List<All_Transactions> all_transactionsList;
    public Adapter_AllTransactions(List<All_Transactions> all_transactionsList){
    ...
    public void onBindViewHolder(@NonNull TransactionsViewHolder holder, int position) {
        ...
        holder.lblPointsxx.setText(all_transactionsList.get(position).getPointsxx());
        holder.lblDateTime.setText(all_transactionsList.get(position).getDateTime());
    }

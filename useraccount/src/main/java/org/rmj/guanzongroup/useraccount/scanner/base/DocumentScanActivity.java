...
package org.rmj.guanzongroup.useraccount.scanner.base;
...
import org.rmj.guanzongroup.useraccount.scanner.libraries.NativeClass;
...
public abstract class DocumentScanActivity extends AppCompatActivity {
    ...
    public boolean initializeCropping() {
        ...
        try {
            ...
            getPolygonView().setPointColor(getResources().getColor(R.color.guanzon_digital_grey));
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;

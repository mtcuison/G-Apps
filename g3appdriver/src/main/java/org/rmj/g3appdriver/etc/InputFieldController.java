...
public class InputFieldController {
    ...
    public static ArrayAdapter<String> getAutoCompleteData(Context foContext, ArrayList<String> foListDta) {
        ArrayAdapter<String> loAdapter = new ArrayAdapter<>(foContext, android.R.layout.simple_spinner_dropdown_item, foListDta);
        return loAdapter;
    }

    public static class OnDateSetListener implements TextWatcher {

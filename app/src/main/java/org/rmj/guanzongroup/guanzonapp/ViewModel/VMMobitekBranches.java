...
public class VMMobitekBranches extends AndroidViewModel {

    private static final String TAG = VMMobitekBranches.class.getSimpleName();
    private final Application instance;
    private final RBranchInfo poBranch;
    private MutableLiveData<List<EBranchInfo>> eBranchInfoList;
    public VMMobitekBranches(@NonNull Application application) {
        super(application);

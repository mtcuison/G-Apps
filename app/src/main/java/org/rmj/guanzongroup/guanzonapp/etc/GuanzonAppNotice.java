...
public class GuanzonAppNotice {
    private static final String TAG = GuanzonAppNotice.class.getSimpleName();
    ...
    private static final String CHANNEL_NAME = "Guanzon App";
    private static final String NotificationID = "rmj.android_G_App";

    public GuanzonAppNotice(Context context, String Message, int channel_id){

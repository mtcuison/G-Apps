...
//        this.repository = new RBranch(instance);
    ...
    public void ImportData(ImportDataCallback callback) {
        try {
            new ImportEventsTask(callback, instance).execute(new JSONObject());
        } catch (Exception e){
            e.printStackTrace();
        }
    }

    private static class ImportEventsTask extends AsyncTask<JSONObject, Void, String> {
...
//        private final RBranch repository;
        ...
        public ImportEventsTask(ImportDataCallback callback, Application instance) {

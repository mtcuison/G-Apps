...
public class Adapter_NewsEvents extends RecyclerView.Adapter<Adapter_NewsEvents.NewsEvents>{
    ...
    private List<EEvents> news_eventsList;
    private EEvents news_events;
    private OnEventItemClickListener listener;

    public Adapter_NewsEvents(List<EEvents> news_eventsList, OnEventItemClickListener listener){
    ...
    public void onBindViewHolder(@NonNull NewsEvents holder, int position) {
        ...
        holder.lblTitle.setText(getTitle(news_events.getEventTle(), news_events.getBranchNm()));
        holder.lblDate.setText(Date_Readable_Format(news_events.getEvntFrom())+ " - " + Date_Readable_Format(news_events.getEvntThru()));
        holder.lblLocation.setText(news_events.getEventURL());
        holder.lblTime.setText(news_events.getBranchNm());
        holder.imgThumbl.setImageBitmap(getImageThumbnail(news_events.getImageURL()));
    }
        ...
        NewsEvents(@NonNull View itemView, final OnEventItemClickListener listener) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    listener.OnClick(events.getTransNox() ,events.getEventURL());
                }
            });
        }
    }

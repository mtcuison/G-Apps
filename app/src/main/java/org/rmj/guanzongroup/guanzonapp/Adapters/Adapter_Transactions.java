...
public class Adapter_Transactions extends RecyclerView.Adapter<Adapter_Transactions.TransactionsViewHolder> {
    ...
    private List<EGCardTransactionLedger> transactionsList;

    public Adapter_Transactions(List<EGCardTransactionLedger> transactionsList){
    ...
    public void onBindViewHolder(@NonNull TransactionsViewHolder holder, int position) {
        ...
        holder.lblPointsxx.setText(String.valueOf(transactionsList.get(position).getPointsxx()));
        holder.lblDateTime.setText(transactionsList.get(position).getTransact());
        holder.lblTranType.setText(transactionsList.get(position).getTranType());
    }

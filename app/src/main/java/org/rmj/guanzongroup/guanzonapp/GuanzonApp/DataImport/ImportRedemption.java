...
public class ImportRedemption extends CodeGenerator implements GapImportInstance {
    ...
    public void sendRequest(Context context, onImportResultListener listener) {
        ...
        if(connectionUtil.isDeviceConnected()){
            httpRequestUtil.sendRequest(new WebApi(mContext).URL_IMPORT_TRANSACTIONS_REDEMPTION(), new HttpRequestUtil.onServerResponseListener() {
                @Override

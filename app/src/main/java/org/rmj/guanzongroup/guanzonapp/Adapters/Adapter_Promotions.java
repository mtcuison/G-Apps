...
public class Adapter_Promotions extends RecyclerView.Adapter<Adapter_Promotions.PromotionViewHolder> {
    ...
    public Adapter_Promotions(Context context, List<Promotions> promotionsList){
    ...
    public void onBindViewHolder(@NonNull PromotionViewHolder holder, int position) {
        ...
        Promotions promotions = promotionsList.get(position);

        holder.lblCaption.setText(promotions.getPromoCaption());
        holder.lblDuration.setText(getPromoDate(promotions));
        holder.imgPromo.setImageBitmap(getImageThumbnail(promotions.getPromoImage()));
    }
        ...
        PromotionViewHolder(@NonNull View itemView, final onPromotionClickListener listener,
            ...
            btnSocial.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(listener != null) {
                        listener1.onClick(promotions.getPromoLink(), promotions.getPromoCaption());
                    } else {
            ...
            btnShare.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(listener != null) {
                        listener2.onClick(promotions.getPromoLink());
                    } else {
                        Log.e("Adapter OnButtonClik", "You might not initialize a method or listener for this button");
                    }
                }
                ...
                public void onClick(View v) {
                    if(listener != null){
                        ...
                        if(position != RecyclerView.NO_POSITION){
                            listener.onClick(position, promotions.getPromoLink());
                        }
                    }
                }
            });
    ...
    private String getPromoDate(Promotions promos){
        if(promos.getPromoDateThr().equalsIgnoreCase("")){
            return "";
        }
        return "Promo runs until " + promos.getPromoDateThr();
    }
